...
class CSRFMultiSchemeDebugPanel(DebugPanel):
    ...
    def _process_response_deferred(self):
        ...
        # [('Set-Cookie', 'ci_ss_ck=eXrTEtumW4Jal3FyEXtkJijofCAyOnayzGQiPG7IAjukycfE; Domain=.dev.cliqued.in; Path=/'),
        #  ('Set-Cookie', 'ci_s_ck=iG6dqE5mff_iR2Y95o5eENuVdC; Domain=.dev.cliqued.in; Path=/')
        #  ]
        for ck in cookies:
            ck_parts = ck[1].split(';')
